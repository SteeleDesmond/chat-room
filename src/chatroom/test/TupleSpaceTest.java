...
import chatroom.tuplespace.TupleSpaceInterface;

/**
 * Used to test the Tuple Spaces for correctness and efficiency. The tests are called via the chat room for ease of
 * access.
 */
public class TupleSpaceTest {

    /**
     * Takes a class that implements the TupleSpaceInterface and performs the various tests. New Tuple spaces are
     * created and passed to the test when the command is entered in the chat room.
     * @param ts The TupleSpace to test
     */
    public void runCorrectnessTest(TupleSpaceInterface ts) {
     ...
     * created and passed to the test when the command is entered in the chat room.
     * @param ts The TupleSpace to test
     * @param testSize the number of tuples to add to the stress test divided by 4.
     */
    public void runStressTest(TupleSpaceInterface ts, int testSize) {
